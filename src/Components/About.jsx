    ...
    <>
        ...
        <div className='abtcontainer'>
            ...
            <div className='abtcontainercontent'>
                <p style={{color:'black'}}>
                Taking advantage of vast warehouses across the India, we stock over 1 million titles for immediate delivery -- that's more titles than any other online bookseller.
<br></br>
<br></br>
